...
FrequencyEq.prototype.setType = function(type) {
  this.type = type;
  this.calcFilter();
};
...
FrequencyEq.prototype.calcFreqz = function(freqs) {
  ...
  var a = [this.filter.a0, this.filter.a1, this.filter.a2];
  var b = [this.filter.b0, this.filter.b1, this.filter.b2];

  var buf = DSP.freqz(b, a, this.buffer);
